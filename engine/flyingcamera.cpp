...
void cx::engine::flying_camera::update(GLuint time_elapsed) {
    ...
    glm::vec3 vel = glm::rotate(orientation,
    ...
    orientation =
            orientation
            * glm::angleAxis(time_elapsed*rollVel, glm::vec3(0, 1, 0))
            * glm::angleAxis(time_elapsed*pitchVel, glm::vec3(1, 0, 0))
            * glm::angleAxis(time_elapsed*yawVel, glm::vec3(0, 0, 1));
...
glm::mat4 cx::engine::flying_camera::get_transformation() {
    return look * glm::toMat4(orientation) * glm::translate(glm::mat4x4(1.0f), -position);
...
cx::engine::flying_camera::flying_camera(glm::vec3 position, glm::vec3 direction, glm::vec3 up, cx::engine::eventing* events)
 ...
 //   orientation = glm::angleAxis(std::acos(glm::dot(ahead, direction)),
//            glm::normalize(glm::cross(ahead, direction))
//            );
